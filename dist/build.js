        ...
        if (typeof Proxy !== 'undefined') {
                ...
                created: function created() {
                    ...
                    this.$options.sockets = new Proxy({}, {
                        set: function set(target, key, value) {
                            _Emitter2.default.addListener(key, value, _this);
                            target[key] = value;
                            return true;
                        },
                        deleteProperty: function deleteProperty(target, key) {
                            _Emitter2.default.removeListener(key, _this.$options.sockets[key], _this);
                            delete target.key;
                            return true;
                        }
                    });
            ...
            Vue.mixin({
                created: function created() {
                    ...
                    if (sockets) {
                        Object.keys(sockets).forEach(function (key) {
                            _Emitter2.default.addListener(key, sockets[key], _this3);
                        });
                    }
                },
                beforeDestroy: function beforeDestroy() {
                    ...
                    if (sockets) {
                        Object.keys(sockets).forEach(function (key) {
                            delete _this4.$options.sockets[key];
                        });
                    }
                }
            });
    ...
    _createClass(_class, [{
        ...
        value: function onEvent() {
            ...
            this.Socket.onevent = function (packet) {
                ...
                if (_this2.store) _this2.passToStore('SOCKET_' + packet.data[0], [].concat(_toConsumableArray(packet.data.slice(1))));
            };
